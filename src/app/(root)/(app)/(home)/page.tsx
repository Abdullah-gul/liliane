...
import { FaYoutube, FaInstagram, FaWhatsapp, FaLinkedin } from 'react-icons/fa'
    ...
    <div className="relative flex min-h-full w-full flex-col items-center justify-center">
      <div className="relative flex items-center justify-center py-3">
        ...
        <div className="absolute -bottom-1/4 mx-auto flex">
          ...
          <a href={SOCIALS.UT} aria-label="GitHub" target="_blank" rel="noopener" className="mx-2 block p-2 opacity-80 hover:opacity-95">
            <FaYoutube size={20} />
          </a>
